...
BOT_NAME = 'pochanwenshu'

SPIDER_MODULES = ['pochanwenshu.spiders']
NEWSPIDER_MODULE = 'pochanwenshu.spiders'

COMMANDS_MODULE = 'pochanwenshu.commands'
